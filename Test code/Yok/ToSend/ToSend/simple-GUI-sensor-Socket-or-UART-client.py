...
def main():
        ...
        # Cybot Forward command Button
        scan_forward_Button = tk.Button(text ="Press to W", command = send_forward)
        scan_forward_Button.pack() # Pack the button into the window for display

        # Cybot Backward command Button
        scan_backward_Button = tk.Button(text ="Press to S", command = send_backward)
        scan_backward_Button.pack() # Pack the button into the window for display

        # Cybot Left command Button
        scan_left_Button = tk.Button(text ="Press to A", command = send_left)
        scan_left_Button.pack() # Pack the button into the window for display

        # Cybot Right command Button
        scan_right_Button = tk.Button(text ="Press to D", command = send_right)
        scan_right_Button.pack() # Pack the button into the window for display
